...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">		  	
		    <label for="addr" id="postcode" class="col-sm-offset-1 col-sm-3 control-label">주소</label>
		    <div class="col-sm-4">
		    <input type="text" class="form-control" id="sample4_roadAddress" name="addr" placeholder="도로명주소" >
		    <input type="text" class="form-control" id="sample4_detailAddress" name="addrDtail" placeholder="상세주소">
		    </div>		    
		    <div class="col-sm-2">
